...
public class MortgageController {
	...
	public MortgageController() {
		...
		System.err.println(
				"--------------------------------------- Welcome to Mortgage Form -------------------------------------");
	}

	@PostMapping("/apply")
	public ResponseEntity<Mortgage> addMortgage(@RequestBody Mortgage mortgage) throws Exception {
		return new ResponseEntity<>(mortgageService.addMortgage(mortgage), HttpStatus.OK);
	}
	...
	public ResponseEntity<List<MortgageDTO>> getAllMortgage() {
		...
		return new ResponseEntity<>(allMortgageDTO, HttpStatus.OK);
	}
